...
$(document).ready(function() {
  ...
  */
  ...
  if ($('#mediaPlaceholder1')) {
    var mediaPlaceholder1 = new ImagePlaceholder($('#mediaPlaceholder1').get(0), null, {alButton: 'Add File'});
  }
  if ($('#mediaPlaceholder2')) {
    var mediaPlaceholder2 = new ImagePlaceholder($('#mediaPlaceholder2').get(0), null, {alButton: 'Add File'});
  }
  $('#actionType1 li').click(function(e) {
    var target = e.target.dataset.target;
    switch (target) {
      case 'externalLink1':
      $('#externalLink1').removeClass('hidden');
      $('#content1').addClass('hidden');
      $('#media1').addClass('hidden');
      break;

      case 'content1':
      $('#content1').removeClass('hidden');
      $('#externalLink1').addClass('hidden');
      $('#media1').addClass('hidden');
      break;

      case 'media1':
      $('#media1').removeClass('hidden');
      $('#content1').addClass('hidden');
      $('#externalLink1').addClass('hidden');
      break;
    }
  });
  $('#actionType2 li').click(function(e) {
    var target = e.target.dataset.target;
    switch (target) {
      case 'externalLink2':
      $('#externalLink2').removeClass('hidden');
      $('#content2').addClass('hidden');
      $('#media2').addClass('hidden');
      break;

      case 'content2':
      $('#content2').removeClass('hidden');
      $('#externalLink2').addClass('hidden');
      $('#media2').addClass('hidden');
      break;

      case 'media2':
      $('#media2').removeClass('hidden');
      $('#content2').addClass('hidden');
      $('#externalLink2').addClass('hidden');
      break;
    }
  });
  initOneCollectionSection($('#content1'), collectionItems, 'Content Item');
  initOneCollectionSection($('#content2'), collectionItems, 'Content Item');
