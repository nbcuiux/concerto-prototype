...
$(document).ready(function() {
    ...
    */
    ...
    renderContent($('#contentLibrary'), store, renderContentHeaderRow, renderContentRow);
    store.setElement($('#contentLibrary'));
    store.setMainRender(renderContent);
    store.setHeaderRender(renderContentHeaderRow);
    store.setRowRender(renderContentRow);
    ...
    var pagination = new Pagination($('#contentPagination'), store, renderData);
    ...
    function handleApplyFilters() {
        store.setFilters(globalFilters);
        store.setPage(0);
        renderContent($('#contentLibrary'), store, renderContentHeaderRow, renderContentRow);
        pagination._init();
        //globalFilters = [];
