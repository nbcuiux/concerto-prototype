...
var LinkRepeater = React.createClass({
  ...
  render() {
    ...
    return (
      <div className="link__repeater">
        <FormField.RadioToggle label="Do you use one or many links?" options={ [ "Single link", "Multiple links" ] } selectedOption={this.state.isSingle} onChange={this.toggleSingle}/>
        {
...
var LinkItemSingle = React.createClass({
