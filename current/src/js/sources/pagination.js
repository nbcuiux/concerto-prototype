...
Pagination.prototype._init = function() {
    ...
    function handlePageClick(e) {
        ...
        console.log("self.customUpdateRow = ", self.customUpdateRow);

        if (self.customUpdateRow != null) {
            self.update($('#libraryBody'), self.store, self.customUpdateRow);
        } else {
    ...
    function renderPagination() {
        ...
        if (self.store.pagesNumber() > 1) {
            //Prev
            var prevLink = $('<li><i class="fa fa-angle-left"></i></li>').addClass('pagination__prev').attr('data-target', 'prev').click($.proxy(handlePageClick,this));
            ...
            //Next
            var nextLink = $('<li><i class="fa fa-angle-right"></i></li>').addClass('pagination__next').attr('data-target', 'next').click($.proxy(handlePageClick,this));
