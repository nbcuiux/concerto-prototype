...
function showModalPrompt(options) {
    var modalClass = options.dialog ? 'c-Modal c-Modal--prompt c-Modal--dialog' : 'c-Modal c-Modal--prompt',
        secButtonClass = options.dialog ? 'button button_style_outline-gray' : 'button button_style_outline-white',
        close = $('<div></div>').addClass('c-Modal-close').click(options.cancelAction),
        modal = $('<div></div>').addClass(modalClass),
        title = options.title ? $('<div></div>').addClass('c-Modal-title').text(options.title) : null,
        text = options.text ? $('<div></div>').addClass('c-Modal-text').text(options.text) : null,
        controls = options.confirmAction || options.cancelAction ? $('<div></div>').addClass('c-Modal-controls') : null,
...
Modal.prototype._init = function() {
    this.modal = $('<div></div>').addClass(this.options.dialog ? 'c-Modal c-Modal--prompt c-Modal--dialog' : 'c-Modal c-Modal--prompt c-Modal--full');

    this.closeButton = $('<div></div>').addClass('c-Modal-close');
    this.title = this.options.title ? $('<div></div>').addClass('c-Modal-title').text(this.options.title) : null;
    this.text = this.options.text ? $('<div></div>').addClass('c-Modal-text').text(this.options.text) : null;

    this.controls = $('<div></div>').addClass('c-Modal-controls');
