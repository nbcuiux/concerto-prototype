...
var ImagePlaceholder = require("../imagePlaceholderNew.js");
...
FormField.Repeater = class Repeater extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="repeater__wrapper" ref="container">
        ...
        <div className="repeater__add" onClick={this.addItem.bind(this)}>
